...
# [howto/manual]).
latex_documents = [
    ("index", "pyscal.tex", u"pyscal Documentation", u"H. Berland", "manual")
]
...
man_pages = [("index", "pyscal", u"pyscal Documentation", [u"H. Berland"], 1)]
