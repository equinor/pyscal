...
latex_documents = [(master_doc, "pyscal.tex", "pyscal Documentation", author, "manual")]
...
man_pages = [(master_doc, "pyscal", "pyscal Documentation", [author], 1)]
